...
public class BrowserFactory {
    ...
    public WebDriver getDriver(String browser,
        ...
        switch (browserEnum) {
            case CHROME:
                WebDriverManager.chromedriver().setup(); //Added WebDriver Manager to get the Chrome Driver version and download
    ...
    private WebDriver getFirefoxDriver(String userAgent,
        ...
        if (osName.toLowerCase().contains("windows")) {
            if (osArchitecture.contains("64")) {
                ...
                System.setProperty("webdriver.gecko.driver", "./drivers/geckodriver-v0.26.0-win32.exe");
            }
        } else {
            if (osArchitecture.contains("64")) {
                System.setProperty("webdriver.gecko.driver", "./drivers/geckodriver-v0.26.0-linux64");
            } else {
                System.setProperty("webdriver.gecko.driver", "./drivers/geckodriver-v0.26.0-linux32");
            }
        }
